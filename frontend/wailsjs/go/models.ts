export namespace model {
	...
	export class GitHubSource {
	    ...
	    static createFrom(source: any = {}) {
	        return new GitHubSource(source);
	    }
	...
	export class GitHubSourceSettings {
	    enabled: boolean;
	    selectedId: string;
	    sources: GitHubSource[];
	    presetSources: GitHubSource[];
	    customSources: GitHubSource[];
	
	    static createFrom(source: any = {}) {
	        return new GitHubSourceSettings(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.sources = this.convertValues(source["sources"], GitHubSource);
	        this.presetSources = this.convertValues(source["presetSources"], GitHubSource);
	        this.customSources = this.convertValues(source["customSources"], GitHubSource);
	    }
